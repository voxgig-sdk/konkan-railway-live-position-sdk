...
This API provides real-time data on the positions of trains operating within the Konkan Railway network.

Learn more about Konkan Railway Live Position at [konkan-railway-api.vercel.app](https://konkan-railway-api.vercel.app).
...
$trains = $client->Train()->list();
print_r(array_map(fn($item) => $item->data_get(), $trains));
