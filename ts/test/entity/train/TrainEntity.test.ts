...
import { KonkanRailwayLivePositionSDK, BaseFeature, stdutil } from '../../..'
...
describe('TrainEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let train_ref01_data = Object.values(setup.data.existing.train)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/train/TrainTestData.json')
  ...
  let client = KonkanRailwayLivePositionSDK.test(options, extra)
