...
exports.KonkanRailwayLivePositionEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends KonkanRailwayLivePositionEntityBase<Advice>`.
class KonkanRailwayLivePositionEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.KonkanRailwayLivePositionEntityBase = KonkanRailwayLivePositionEntityBase;
//# sourceMappingURL=KonkanRailwayLivePositionEntityBase.js.map