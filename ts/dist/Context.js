...
const KonkanRailwayLivePositionError_1 = require("./KonkanRailwayLivePositionError");
...
class Context {
    ...
    error(code, msg) {
        return new KonkanRailwayLivePositionError_1.KonkanRailwayLivePositionError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
