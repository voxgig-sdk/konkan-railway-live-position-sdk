...
Results: Successful response with list of trains; Successful response with train details.
...
| --- | --- | --- | --- |
| Train | `list` | `GET /api/trains` | See reference |
| Train | `load` | `GET /api/trains/{trainNumber}` | See reference |

## Connect to the API

- Production server: `https://konkan-railway-api.vercel.app`
...
- `konkan-railway-live-position_list`: List records for an entity. Supported entities: `train`.
- `konkan-railway-live-position_load`: Load one record for an entity. Supported entities: `train`.
