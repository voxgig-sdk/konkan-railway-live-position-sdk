...
|---|---|---|
| `ts/` | @voxgig-sdk/konkan-railway-live-position-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/konkan-railway-live-position-sdk \
      --repository voxgig-sdk/konkan-railway-live-position-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/konkan-railway-live-position-sdk` shows it, and
`npm trust revoke @voxgig-sdk/konkan-railway-live-position-sdk --id=<id>` removes it.
