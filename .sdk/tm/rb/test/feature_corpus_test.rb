# KonkanRailwayLivePosition SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # KonkanRailwayLivePositionSDK.new, not KonkanRailwayLivePositionSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    KonkanRailwayLivePositionSDK.new(opts)
  end
