...
// KonkanRailwayLivePosition SDK timeout feature
...
class KonkanRailwayLivePositionTimeoutFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _with_timeout(KonkanRailwayLivePositionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KonkanRailwayLivePositionContext $_ctx, float $ms): void
    {
        $client = $this->client;
