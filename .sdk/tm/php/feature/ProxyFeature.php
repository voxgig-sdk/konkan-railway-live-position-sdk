...
// KonkanRailwayLivePosition SDK proxy feature
...
class KonkanRailwayLivePositionProxyFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    public function init(KonkanRailwayLivePositionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KonkanRailwayLivePositionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
