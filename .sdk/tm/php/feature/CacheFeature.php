...
// KonkanRailwayLivePosition SDK cache feature
...
class KonkanRailwayLivePositionCacheFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _through(KonkanRailwayLivePositionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
