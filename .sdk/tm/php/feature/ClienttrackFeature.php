...
// KonkanRailwayLivePosition SDK clienttrack feature
...
class KonkanRailwayLivePositionClienttrackFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    public function PostConstruct(KonkanRailwayLivePositionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KonkanRailwayLivePosition-SDK';
