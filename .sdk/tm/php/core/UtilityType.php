...
// KonkanRailwayLivePosition SDK utility type

class KonkanRailwayLivePositionUtility
{
    ...
    public static function copy(KonkanRailwayLivePositionUtility $src): KonkanRailwayLivePositionUtility
    {
        $u = new KonkanRailwayLivePositionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
