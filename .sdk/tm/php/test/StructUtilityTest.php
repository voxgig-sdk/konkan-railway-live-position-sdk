...
// KonkanRailwayLivePosition SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KonkanRailwayLivePositionOmni::makeStructRunner(
    ...
    {
        return KonkanRailwayLivePositionOmni::objmodel(KonkanRailwayLivePositionOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return KonkanRailwayLivePositionOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return KonkanRailwayLivePositionOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KonkanRailwayLivePositionOmni::structfix($now, Struct::undef()))
                        !== json_encode(KonkanRailwayLivePositionOmni::structfix($val, Struct::undef()))) {
