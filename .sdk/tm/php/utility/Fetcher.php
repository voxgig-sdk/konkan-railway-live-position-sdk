...
// KonkanRailwayLivePosition SDK utility: fetcher

class KonkanRailwayLivePositionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KonkanRailwayLivePositionSDK/1.0)';
    ...
    public static function call(KonkanRailwayLivePositionContext $ctx, string $fullurl, array $fetchdef): array
    {
