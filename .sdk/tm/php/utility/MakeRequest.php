...
// KonkanRailwayLivePosition SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KonkanRailwayLivePositionMakeRequest
{
    public static function call(KonkanRailwayLivePositionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KonkanRailwayLivePositionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KonkanRailwayLivePositionResponse($fetched);
        } else {
