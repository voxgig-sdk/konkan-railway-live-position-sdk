...
// KonkanRailwayLivePosition SDK utility: result_basic

class KonkanRailwayLivePositionResultBasic
{
    public static function call(KonkanRailwayLivePositionContext $ctx): ?KonkanRailwayLivePositionResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof KonkanRailwayLivePositionError) ? $result->err->msg : (string)$result->err;
