...
// KonkanRailwayLivePosition SDK utility: graphql
//
...
class KonkanRailwayLivePositionGraphql
{
    ...
    // equivalent.
    public static function body(KonkanRailwayLivePositionContext $ctx): mixed
    {
    ...
    public static function errors(KonkanRailwayLivePositionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
