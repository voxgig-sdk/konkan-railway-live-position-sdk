...
type TrainEntity struct {
	name    string
	client  *core.KonkanRailwayLivePositionSDK
...
func NewTrainEntity(client *core.KonkanRailwayLivePositionSDK, entopts map[string]any) *TrainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrainEntity) GetName() string { return e.name }
...
func (e *TrainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrainEntity) Deleted() bool {
	return e.deleted
}


func (e *TrainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrainEntity(e.client, opts)
}

func (e *TrainEntity) Data(args ...any) any {
...
func (e *TrainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Train; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrainEntity) DataTyped(data ...Train) Train {
	if len(data) > 0 {
		return typedFrom[Train](e.Data(asMap(data[0])))
	}
	return typedFrom[Train](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Train (all fields
// optional at the wire level).
func (e *TrainEntity) MatchTyped(match ...Train) Train {
	if len(match) > 0 {
		return typedFrom[Train](e.Match(asMap(match[0])))
	}
	return typedFrom[Train](e.Match())
}
...
func (e *TrainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrainLoadMatch and returns an Train. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TrainEntity) LoadTyped(reqmatch TrainLoadMatch, ctrl map[string]any) (Train, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Train{}, err
	}
	return typedFrom[Train](res), nil
}




func (e *TrainEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TrainListMatch and returns []Train. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TrainEntity) ListTyped(reqmatch TrainListMatch, ctrl map[string]any) ([]Train, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Train](res), nil
}



func (e *TrainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TrainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
