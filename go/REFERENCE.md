# KonkanRailwayLivePosition Golang SDK Reference

Complete API reference for the KonkanRailwayLivePosition Golang SDK.
...
#### `Test() *KonkanRailwayLivePositionSDK`
...
#### `TestSDK(testopts, sdkopts map[string]any) *KonkanRailwayLivePositionSDK`
...
#### `Train(data map[string]any) KonkanRailwayLivePositionEntity`
...
fmt.Println(train.GetName()) // "train"
```
...
| `latitude` | `float64` | No | Current latitude coordinate of the train |
| `longitude` | `float64` | No | Current longitude coordinate of the train |
