...
require_relative 'KonkanRailwayLivePosition_types'
...
class KonkanRailwayLivePositionSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = KonkanRailwayLivePositionHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = KonkanRailwayLivePositionHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, KonkanRailwayLivePositionFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    KonkanRailwayLivePositionUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = KonkanRailwayLivePositionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = KonkanRailwayLivePositionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = KonkanRailwayLivePositionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => KonkanRailwayLivePositionError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue KonkanRailwayLivePositionError => err
    ...
    if fetched.is_a?(Hash)
      status = KonkanRailwayLivePositionHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = KonkanRailwayLivePositionError.new(
        "graphql_error", "KonkanRailwayLivePositionSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = KonkanRailwayLivePositionSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
