...
#      offline in seeded test mode (KonkanRailwayLivePositionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "KonkanRailwayLivePosition_sdk.rb")
  SDK_CLASS = "KonkanRailwayLivePositionSDK"
  ...
  SDK_BASE = "KonkanRailwayLivePosition_sdk"
