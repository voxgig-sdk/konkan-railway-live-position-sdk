...
AQL-driven CLI and REPL for the KonkanRailwayLivePosition SDK. Positional arguments are
...
```sh
go build -o konkan-railway-live-position-cli ./...
```
...
./konkan-railway-live-position-cli load 1 train
./konkan-railway-live-position-cli load '{id:1}' train
