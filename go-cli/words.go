...
func registerSDKWords(r *eng.Registry, client *sdk.KonkanRailwayLivePositionSDK) {
...
func runOp(client *sdk.KonkanRailwayLivePositionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
