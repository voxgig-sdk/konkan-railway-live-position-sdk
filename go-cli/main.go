// Command KonkanRailwayLivePosition-cli is a CLI + REPL for the KonkanRailwayLivePosition SDK,
...
const prompt = "konkan-railway-live-position"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "train"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      KONKAN_RAILWAY_LIVE_POSITION_APIKEY (api key), KONKAN_RAILWAY_LIVE_POSITION_BASE (base url override)")
