...
type Args struct {
	Entity string         `json:"entity" jsonschema:"train"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KonkanRailwayLivePositionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "konkan-railway-live-position_list",
		Description: "List records from KonkanRailwayLivePosition. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "konkan-railway-live-position_load",
		Description: "Load a single record from KonkanRailwayLivePosition. " +
...
func runOp(client *sdk.KonkanRailwayLivePositionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KonkanRailwayLivePositionSDK, name string) (sdk.KonkanRailwayLivePositionEntity, error) {
	switch strings.ToLower(name) {
	case "train":
		return client.Train(nil), nil
