// Command KonkanRailwayLivePosition-mcp is an MCP server exposing the KonkanRailwayLivePosition
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KonkanRailwayLivePosition_list  — list records of an entity
//	KonkanRailwayLivePosition_load  — load a single record of an entity
//
