...
from konkanrailwayliveposition_sdk.core.helpers import get_ctx_prop, to_map
...
class KonkanRailwayLivePositionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = KonkanRailwayLivePositionControl()
        ...
        if isinstance(sp, KonkanRailwayLivePositionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KonkanRailwayLivePositionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KonkanRailwayLivePositionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return KonkanRailwayLivePositionOperation({})
    ...
    def make_error(self, code, msg):
        return KonkanRailwayLivePositionError(code, msg, self)
