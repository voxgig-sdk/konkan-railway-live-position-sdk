...
from konkanrailwayliveposition_sdk.utility import register

# Load features
from konkanrailwayliveposition_sdk.feature.base_feature import KonkanRailwayLivePositionBaseFeature
from konkanrailwayliveposition_sdk.features import _has_feature, _make_feature
...
class KonkanRailwayLivePositionSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KonkanRailwayLivePositionUtility()
    ...
    def get_utility(self):
        return KonkanRailwayLivePositionUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KonkanRailwayLivePositionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Train(self, data=None) -> "TrainEntity":
        ...
        from konkanrailwayliveposition_sdk.entity.train_entity import TrainEntity
