# KonkanRailwayLivePosition SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KonkanRailwayLivePositionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KonkanRailwayLivePositionSDK(...) and KonkanRailwayLivePositionSDK.test(...) become
#      KonkanRailwayLivePositionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "konkanrailwayliveposition_sdk"
_SDK_CLASS = "KonkanRailwayLivePositionSDK"
