# KonkanRailwayLivePosition PHP SDK Reference

Complete API reference for the KonkanRailwayLivePosition PHP SDK.
...
#### `KonkanRailwayLivePositionSDK::test($testopts = null, $sdkopts = null)`
