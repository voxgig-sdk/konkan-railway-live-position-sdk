...
// KonkanRailwayLivePosition SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KonkanRailwayLivePositionTestFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    public function init(KonkanRailwayLivePositionContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KonkanRailwayLivePositionContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KonkanRailwayLivePositionParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KonkanRailwayLivePositionContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KonkanRailwayLivePositionContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = KonkanRailwayLivePositionParam::call($ctx, $k);
