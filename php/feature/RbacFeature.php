...
// KonkanRailwayLivePosition SDK rbac feature
...
class KonkanRailwayLivePositionRbacFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _required(KonkanRailwayLivePositionContext $ctx): ?string
    {
    ...
    private function _reject(KonkanRailwayLivePositionContext $ctx, string $required): void
    {
    ...
    private function _track(KonkanRailwayLivePositionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
