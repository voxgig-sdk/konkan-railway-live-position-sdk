...
// KonkanRailwayLivePosition SDK metrics feature
...
class KonkanRailwayLivePositionMetricsFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _record(KonkanRailwayLivePositionContext $ctx, bool $ok): void
    {
