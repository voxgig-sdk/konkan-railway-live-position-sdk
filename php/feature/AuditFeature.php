...
// KonkanRailwayLivePosition SDK audit feature
...
class KonkanRailwayLivePositionAuditFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _emit(KonkanRailwayLivePositionContext $ctx, string $outcome): void
    {
