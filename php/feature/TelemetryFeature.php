...
// KonkanRailwayLivePosition SDK telemetry feature
...
class KonkanRailwayLivePositionTelemetryFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _close(KonkanRailwayLivePositionContext $ctx, bool $ok): void
    {
