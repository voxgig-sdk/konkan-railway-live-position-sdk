...
// KonkanRailwayLivePosition SDK ratelimit feature
...
class KonkanRailwayLivePositionRatelimitFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _acquire(KonkanRailwayLivePositionContext $ctx): void
    {
    ...
    private function _track(KonkanRailwayLivePositionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
