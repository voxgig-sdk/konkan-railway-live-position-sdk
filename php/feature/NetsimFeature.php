...
// KonkanRailwayLivePosition SDK netsim feature
...
class KonkanRailwayLivePositionNetsimFeature extends KonkanRailwayLivePositionBaseFeature
{
    ...
    private function _simulate(KonkanRailwayLivePositionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KonkanRailwayLivePositionContext $ctx, array $applied): void
    {
        $client = $this->client;
