...
// KonkanRailwayLivePosition SDK utility: make_options

class KonkanRailwayLivePositionMakeOptions
{
    ...
    public static function call(KonkanRailwayLivePositionContext $ctx): array
    {
        ...
        //
        // `KonkanRailwayLivePositionSchema::optspec()` is built from the model:
        ...
        $optspec = KonkanRailwayLivePositionSchema::optspec();
