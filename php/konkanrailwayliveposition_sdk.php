...
class KonkanRailwayLivePositionSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = KonkanRailwayLivePositionHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = KonkanRailwayLivePositionHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!KonkanRailwayLivePositionFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, KonkanRailwayLivePositionFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return KonkanRailwayLivePositionUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = KonkanRailwayLivePositionHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = KonkanRailwayLivePositionHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = KonkanRailwayLivePositionHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new KonkanRailwayLivePositionError($op . "_allow",
                "KonkanRailwayLivePositionSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = KonkanRailwayLivePositionHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new KonkanRailwayLivePositionError("graphql_error",
                "KonkanRailwayLivePositionSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Train($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_train === null) {
                $this->_train = new TrainEntity($this, null);
            }
            return $this->_train;
        }
        return new TrainEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new KonkanRailwayLivePositionSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
