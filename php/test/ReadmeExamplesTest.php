...
// KonkanRailwayLivePosition SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KonkanRailwayLivePositionSDK::test)
...
{
    private const SDK_CLASS = 'KonkanRailwayLivePositionSDK';
    ...
    private const SDK_BASE = 'konkanrailwayliveposition_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../konkanrailwayliveposition_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
