...
// KonkanRailwayLivePosition SDK pipeline test
//
...
{
    private static function utility(): KonkanRailwayLivePositionUtility
    {
        return new KonkanRailwayLivePositionUtility();
    }
    ...
    private static function ctx(array $over = []): KonkanRailwayLivePositionContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KonkanRailwayLivePositionContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KonkanRailwayLivePositionOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KonkanRailwayLivePositionError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KonkanRailwayLivePositionOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KonkanRailwayLivePositionMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KonkanRailwayLivePositionOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KonkanRailwayLivePositionMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KonkanRailwayLivePositionOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KonkanRailwayLivePositionMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KonkanRailwayLivePositionSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KonkanRailwayLivePositionMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KonkanRailwayLivePositionResponse([]),
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        [, $err] = KonkanRailwayLivePositionMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KonkanRailwayLivePositionSpec([]),
            'response' => null,
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        [, $err] = KonkanRailwayLivePositionMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's']),
            'response' => new KonkanRailwayLivePositionResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        [, $err] = KonkanRailwayLivePositionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's']),
            'response' => new KonkanRailwayLivePositionResponse(self::resp(200, ['v' => 1])),
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        [, $err] = KonkanRailwayLivePositionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's']),
            'response' => new KonkanRailwayLivePositionResponse(self::resp(200, ['v' => 2])),
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KonkanRailwayLivePositionMakeResponse::call($ctx);
    ...
    {
        $preset = new KonkanRailwayLivePositionResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KonkanRailwayLivePositionSpec([]),
            'response' => new KonkanRailwayLivePositionResponse([]),
            'result' => new KonkanRailwayLivePositionResult([]),
        ...
        [$got, $err] = KonkanRailwayLivePositionMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KonkanRailwayLivePositionResult([])]);
        [, $err] = KonkanRailwayLivePositionMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KonkanRailwayLivePositionSpec([]), 'result' => null]);
        [, $err] = KonkanRailwayLivePositionMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's']),
            'result' => new KonkanRailwayLivePositionResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KonkanRailwayLivePositionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KonkanRailwayLivePositionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's']),
            'result' => new KonkanRailwayLivePositionResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KonkanRailwayLivePositionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KonkanRailwayLivePositionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KonkanRailwayLivePositionResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KonkanRailwayLivePositionSpec([]),
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KonkanRailwayLivePositionMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KonkanRailwayLivePositionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KonkanRailwayLivePositionError('boom', 'boom');
        $utility->fetcher = function (KonkanRailwayLivePositionContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KonkanRailwayLivePositionMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KonkanRailwayLivePositionContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KonkanRailwayLivePositionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KonkanRailwayLivePositionResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        KonkanRailwayLivePositionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KonkanRailwayLivePositionContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KonkanRailwayLivePositionSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KonkanRailwayLivePositionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KonkanRailwayLivePositionResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KonkanRailwayLivePositionSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KonkanRailwayLivePositionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KonkanRailwayLivePositionMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KonkanRailwayLivePositionMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KonkanRailwayLivePositionResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KonkanRailwayLivePositionDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KonkanRailwayLivePositionResult(['ok' => false])]);
        $this->expectException(KonkanRailwayLivePositionError::class);
        KonkanRailwayLivePositionDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KonkanRailwayLivePositionResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KonkanRailwayLivePositionMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KonkanRailwayLivePositionMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KonkanRailwayLivePositionBaseFeature();
        $b = new KonkanRailwayLivePositionBaseFeature();
        KonkanRailwayLivePositionFeatureAdd::call($ctx, $a);
        KonkanRailwayLivePositionFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KonkanRailwayLivePositionBaseFeature
    {
        $f = new KonkanRailwayLivePositionBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KonkanRailwayLivePositionFeatureAdd::call($ctx, self::named_feature('a'));
        KonkanRailwayLivePositionFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        KonkanRailwayLivePositionFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        KonkanRailwayLivePositionFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        KonkanRailwayLivePositionFeatureAdd::call($ctx, $replace);
        ...
        KonkanRailwayLivePositionFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KonkanRailwayLivePositionContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KonkanRailwayLivePositionSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KonkanRailwayLivePositionPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        KonkanRailwayLivePositionPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KonkanRailwayLivePositionResponse(['headers' => null]),
            'result' => new KonkanRailwayLivePositionResult([]),
        ]);
        KonkanRailwayLivePositionResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        KonkanRailwayLivePositionResultBody::call($ctx);
